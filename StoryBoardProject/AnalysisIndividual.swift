...
//                TODO align more right
            ...
            .frame(width: 300, height: /*@START_MENU_TOKEN@*/50/*@END_MENU_TOKEN@*/, alignment: .top)
            
            Image("analysis-image")
                .resizable()
                .frame(width: 299, height: 370, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
...
//            TODO change font to a custom one
            ...
            .foregroundColor(Color(#colorLiteral(red: 0.4548544884, green: 0.4549351335, blue: 0.4548438787, alpha: 1)))
                .frame(width: 327, height: 154, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
